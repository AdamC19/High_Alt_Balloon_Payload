...
# target
######################################
TARGET = Weather_Balloon_Payload_FW
...
GCC_PATH="C:/PROGRAM FILES (X86)/ARM GNU TOOLCHAIN ARM-NONE-EABI/12.2 MPACBTI-BET1/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/CORDI/DOCUMENTS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/CORDI/DOCUMENTS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f3x mass_erase 0; exit"
